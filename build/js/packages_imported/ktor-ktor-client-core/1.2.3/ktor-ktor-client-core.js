(function(root, factory) {
  ...
  var cancel_0 = $module$kotlinx_coroutines_io.kotlinx.coroutines.io.cancel_ep79e2$;
  ...
  var CancellationException_0 = $module$kotlinx_coroutines_core.kotlinx.coroutines.CancellationException_wspj0f$;
  var cancel_1 = $module$kotlinx_coroutines_core.kotlinx.coroutines.cancel_x105z1$;
  ...
  return true;
      ...
      case 3:
        ...
        if (!instanceOf(this.local$result, this.local$info.type)) {
          var from = Kotlin.getKClassFromExpression(this.local$result);
          var to = this.local$info.type;
          throw new NoTransformationFoundException(from, to);
        }
    ...
    switch (this.state_0) {
      ...
      case 3:
        ...
        if (Kotlin.isType(cause, CancellationException)) {
          ...
          this.state_0 = 6;
          this.$returnValue = (cancel(this.local$this$channelWithCloseHandling, cause) , Unit);
          continue;
        } else {
          throw cause;
        }
      ...
      case 6:
        this.exceptionState_0 = 8;
        this.local$this$channelWithCloseHandling.close();
  ...
  function channelWithCloseHandling($receiver) {
    return writer($receiver, void 0, void 0, channelWithCloseHandling$lambda($receiver)).channel;
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        return cancel_0(this.local$this$HttpResponse.content);
      case 1:
        throw this.exception_0;
      default:
        this.state_0 = 1;
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        var tmp$_3;
        this.state_0 = 2;
        this.result_0 = this.local$$receiver.call.receive_jo9acv$(new TypeInfo(getKClass(Input), package$call.JsType), this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
        throw this.exception_0;
      case 2:
        this.result_0 = Kotlin.isType(tmp$_3 = this.result_0, Input) ? tmp$_3 : throwCCE();
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        ...
        var cause = this.exception_0;
        if (Kotlin.isType(cause, Throwable)) {
          cancel_1(this.local$callContext, CancellationException_0('Failed to connect to ' + this.local$urlString, cause));
          throw cause;
        } else 
          throw cause;
      case 3:
  ...
  function readBody(response, callContext) {
    if (util.PlatformUtils.IS_NODE) {
      return readBodyNode(callContext, response);
    } else {
      return readBodyBrowser(callContext, response);
    }
  }
  function readBodyNode$lambda$lambda(closure$responseData) {
    return function(chunk) {
  return closure$responseData.offer_11rb$(asByteArray(new Uint8Array(chunk)));
};
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        var responseData = Channel(2147483647);
        this.local$body.on('data', readBodyNode$lambda$lambda(responseData));
  ...
  function readBodyNode($receiver, response) {
    return writer(coroutines.GlobalScope, $receiver, void 0, readBodyNode$lambda(response)).channel;
  }
  ...
  if (cause == null) {
    ...
    this$JsWebSocketSession.websocket_0.close(CloseReason$Codes.UNEXPECTED_CONDITION.code, 'Client failed');
  }
  return Unit;
};
  }
