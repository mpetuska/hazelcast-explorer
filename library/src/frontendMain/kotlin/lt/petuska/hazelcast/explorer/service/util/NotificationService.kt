...
object NotificationService {
  fun info(message: String) = send(message, NotificationType.INFO)
  fun success(message: String) = send(message, NotificationType.SUCCESS)
  fun warning(message: String) = send(message, NotificationType.WARNING)
  fun error(message: String) = send(message, NotificationType.ERROR)
